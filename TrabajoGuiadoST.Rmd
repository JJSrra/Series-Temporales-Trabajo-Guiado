...
serie.train.sinTendEst = serie.train.sinTend - estacionalidad
serie.test.sinTendEst = serie.test.sinTend - estacionalidad

plot.ts(serie.train.sinTendEst, xlim=c(1, tiempo.test[length(tiempo.test)]))
lines(tiempo.test, serie.test.sinTendEst, col="red")
```

Aquí se puede observar ya limpiamente la serie temporal sin la tendencia y sin la estacionalidad.
